...
public class ProjectRestControllerIntegrationTest {
	...
	@Test
	public void should_UpdateProject_When_ValidPayLoad() throws Exception {

		SdlcSystem sdlcSystem = new SdlcSystem();
		sdlcSystem.setId(1);

		Project response = buildProject();
		response.setExternalId("EXTERNALIDEDITED");
		response.setName("Name-Edited");
		response.setSdlcSystem(sdlcSystem);


		when(projectService.updateProject(any(Project.class), anyLong())).thenReturn(response);
		...
		mockMvc.perform(patch(ENDPOINT + "/12345")
				...
				.accept(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk())
				.andExpect(jsonPath("$.externalId").value("EXTERNALIDEDITED"))
				.andExpect(jsonPath("$.name").value("Name-Edited"))
				.andExpect(jsonPath("$.sdlcSystem.id").value(1));
	}

	@Test
	public void should_UpdateProject_When_PayLoadWithOnlyExternalId() throws Exception {
	...
	@Test
	public void should_UpdateProject_When_PayLoadWithOnlySDLCSystemId() throws Exception {
	...
	@Test
	public void should_NotUpdateProject_When_PayLoadIsEmpty() throws Exception {
	...
	@Test
	public void should_UpdateProject_When_PayLoadWithNullName() throws Exception {
	...
	@Test
	public void should_ThrowBadRequestException_When_PatchIllegalPathVariable() throws Exception {
	...
	@Test
	public void should_ThrowSdlcSystemNotFoundException_When_PatchPayloadContainingNonExistingSystem() throws Exception {

		when(projectService.updateProject(any(Project.class), anyLong())).thenThrow(SdlcSystemNotFoundException.class);
	...
	@Test
	public void should_ThrowConflictException_When_PayloadContainingConflictingSystemExternalID() throws Exception {

		when(projectService.updateProject(any(Project.class), anyLong())).thenThrow(ConflictException.class);
	...
	@Test
	public void should_ThrowConflictException_When_PayloadContainingConflictingSystemID() throws Exception {
	...
	@Test
	public void should_ThrowConflictException_When_PayloadContainingConflictingExternalId() throws Exception {
	...
	@Test
	public void should_ThrowProjectNotFoundException_When_PatchInvalidPathVariable() throws Exception {
